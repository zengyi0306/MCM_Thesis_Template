...
\caption{CFCs Index\cite{ncep.noaa.gov}\cite{noaa.gov}\label{fig:CFCs index}
\end{figure}
\end{center}
...
\end{figure}
\end{center}
Scientist use models as one important method to doing research. Modeling often means creating a mathematical model -  a set of equations that represent a real system. \cite{shindell1998increased}
\begin{center}
\begin{figure}[htpb]
\centering
